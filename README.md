...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20121876.svg)](https://doi.org/10.5281/zenodo.14764479)
...
> [!NOTE]  
> So far, two [data sets](https://github.com/SEG-UNIBE/tlparser/tree/main/data) are available:
>
> - Direct link to **Spacewire** dataset: [`JSON`](https://raw.githubusercontent.com/SEG-UNIBE/tlparser/refs/heads/main/data/SpaceWire/spacewire.json) or [`PDF`](https://github.com/SEG-UNIBE/tlparser/blob/3886f0153a9acfc27632c45325e2387850e67525/data/SpaceWire/spacewire.pdf)
> - Direct link to **Edge/IoT** dataset: [`JSON`](https://raw.githubusercontent.com/SEG-UNIBE/tlparser/refs/heads/main/data/Edge_IoT/iot.json) or [`XLSX`](https://github.com/SEG-UNIBE/tlparser/raw/refs/heads/main/data/Edge_IoT/Dataset.xlsx)
...
| translation            | Specified whether the requirement can theoretically be formalized in (_translated to_) another logic (possible values are `self`, `yes`, `no`, `unknown`) |
...
| stats.asth             | Height (or _depth_ or _nesting_) of the abstract syntax tree                                                                                              |
